...
#import "NativeAndWebSummaryVC.h"
#import "BAWKWebViewVC2.h"
#import "BAWKWebViewVC3.h"
...
@implementation NativeAndWebSummaryVC
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.row) {
        ...
        case 4:
        {
            BAWKWebViewVC2 *vc2 = [BAWKWebViewVC2 new];
        ...
        case 5:
        {
            BAWKWebViewVC3 *vc2 = [BAWKWebViewVC3 new];
            vc2.title = self.dataArray[indexPath.row];
